...
if __name__ == '__main__':
    ...
    trainer.setting.output_dir = r'\Himani Data\Cx Patient Data\RTDosePrediction-main\RTDosePrediction-main\RTDosePrediction\Output\C3D'
    list_GPU_ids = args.list_GPU_ids

    trainer.setting.network = Model(in_ch=6, out_ch=1,
